...
| [settings_device_tls_en.arb](../source/settings_device_tls_en.arb) | Certificate details, management, validation errors and protocol change confirmation | Settings > Device > TLS and Remote Administration on the device and in remote administration. Keep TLS, HTTPS, PEM, SHA-256, EC and RSA unchanged. |
