...
| [settings_web_browsing_navigation_en.arb](../source/settings_web_browsing_navigation_en.arb) | Reload, zoom and scrolling controls plus the device crash recovery permission notice | Settings > Web Browsing. Also Web Browsing in remote administration, except the permission notice. |
